...
module.exports = {
  ...
  alias: {
    ...
    commons: path.resolve(dirVars.logicDir, 'common.page'),

    /* config */
    configModule: path.resolve(dirVars.configDir, 'common.config'),

     /* script */
    script: path.resolve(dirVars.publicDir, 'script/'),

    /* images */
    images: path.resolve(dirVars.publicDir, 'images/'),

    /* 模板 */
    components: path.resolve(dirVars.publicDir, 'components/'),

    userDir: path.resolve(dirVars.publicDir, 'components/userTemplate/'),
    /*vue*/
    'vueDir': 'vue/dist/vue.min.js'//默认生产版本
  },
